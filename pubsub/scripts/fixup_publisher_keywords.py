...
class PublisherClientCallTransformer(cst.CSTTransformer):
...
def fix_files(
    ...
    files: Sequence[str],
    *,
    transformer=PublisherClientCallTransformer(),
):
    pyfile_gen = chain(
        (os.path.join(root, f)
         for d in dirs
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description="""Fix up source that uses the Publisher client library.
