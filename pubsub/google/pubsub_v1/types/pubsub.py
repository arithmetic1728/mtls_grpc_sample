...
class Topic(proto.Message):
    ...
    message_storage_policy = proto.Field(proto.MESSAGE, number=3,
...
class PubsubMessage(proto.Message):
    ...
    publish_time = proto.Field(proto.MESSAGE, number=4,
...
class PublishRequest(proto.Message):
    ...
    topic = proto.Field(proto.STRING, number=1)
    messages = proto.RepeatedField(proto.MESSAGE, number=2,
...
class ListTopicSubscriptionsResponse(proto.Message):
    ...
    Attributes:
        subscriptions (Sequence[str]):
            The names of the subscriptions that match the
            request.
        next_page_token (str):
...
class RetryPolicy(proto.Message):
    ...
    minimum_backoff = proto.Field(proto.MESSAGE, number=1,
        message=duration.Duration,
    )
    maximum_backoff = proto.Field(proto.MESSAGE, number=2,
        message=duration.Duration,
    )
...
class PushConfig(proto.Message):
    ...
    attributes = proto.MapField(proto.STRING, proto.STRING, number=2)
    oidc_token = proto.Field(proto.MESSAGE, number=3,
        message=OidcToken,
    )
...
class ReceivedMessage(proto.Message):
    ...
    Attributes:
        ...
        delivery_attempt (int):
            ...
            as 1. The value is calculated at best effort and is
            approximate.

            If a DeadLetterPolicy is not set on the subscription, this
            will be 0. EXPERIMENTAL: This feature is part of a closed
            alpha release. This API might be changed in
            backward-incompatible ways and is not recommended for
            production use. It is not subject to any SLA or deprecation
            policy.
...
class ModifyPushConfigRequest(proto.Message):
    ...
    subscription = proto.Field(proto.STRING, number=1)
    push_config = proto.Field(proto.MESSAGE, number=2,
        message=PushConfig,
    )
...
class PullResponse(proto.Message):
    ...
    received_messages = proto.RepeatedField(proto.MESSAGE, number=1,
...
class UpdateSnapshotRequest(proto.Message):
    ...
    snapshot = proto.Field(proto.MESSAGE, number=1,
        message='Snapshot',
    )
    update_mask = proto.Field(proto.MESSAGE, number=2,
        message=field_mask.FieldMask,
...
class ListSnapshotsResponse(proto.Message):
    ...
    snapshots = proto.RepeatedField(proto.MESSAGE, number=1,
        message=Snapshot,
    )
    next_page_token = proto.Field(proto.STRING, number=2)
...
class SeekRequest(proto.Message):
    ...
    subscription = proto.Field(proto.STRING, number=1)
    time = proto.Field(proto.MESSAGE, number=2,
        message=timestamp.Timestamp,
    )
